...
local AlchemyNotify = function(Text_i,Duration_i)
    game.StarterGui:SetCore("SendNotification", {
        ...
        Text = Text_i,
        Duration = Duration_i,
        Icon = "rbxassetid://85457250294641"
    })
end
--Key
wait(0.1)
AlchemyNotify("Thanks for using NEXUS Hub!",5)
wait(0.1)
AlchemyNotify("discord.gg/dUdzZskBCC",5)
wait(0.5)
local Notification = require(game:GetService("ReplicatedStorage").Notification)
Notification.new("<Color=Cyan>NEXUS Hub V2Script<Color=/>"):Display()
wait(0.5)
...
local HomePage = a:Tab("Home", "rbxassetid://85457250294641")
local Main = a:Tab("Main", "rbxassetid://85457250294641")
local Set = a:Tab("Setting", "rbxassetid://85457250294641")
local Farm = a:Tab("Other Farm", "rbxassetid://85457250294641")
local Stats = a:Tab("Stats", "rbxassetid://85457250294641")
local Race = a:Tab("Race V4", "rbxassetid://85457250294641")
local Event = a:Tab("Games Event", "rbxassetid://85457250294641")
local Tele = a:Tab("Teleport", "rbxassetid://85457250294641")
local Player = a:Tab("Player", "rbxassetid://85457250294641")
local DemonFruit = a:Tab("Devil Fruit", "rbxassetid://85457250294641")
local Raid = a:Tab("Raid", "rbxassetid://85457250294641")
local Shop = a:Tab("Shop", "rbxassetid://85457250294641")
local Misc = a:Tab("Misc", "rbxassetid://85457250294641")

HomePage:Seperator("NEXUS Hub")
...
Misc:Button("Fruit Rain [ Old ]", function()
    for i, v in pairs(game:GetObjects("rbxassetid://85457250294641")[1]:GetChildren()) do
